...
const AnimalForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submissionData: Partial<Animal> = {
      ...
      // internal_id is not included here; it will be generated by the backend
    };
    ...
    try {
      if (isEditing && id) {
        ...
        console.log('Created animal with internal_id:', response.internal_id); // Log to verify
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              />
              {!isEditing && (
                <p className="text-sm text-muted-foreground">This will be generated by the system.</p>
              )}
            </div>
