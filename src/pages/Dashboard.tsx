...
const Dashboard: React.FC = () => {
  ...
  // Fetch animals and calculate stats
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        if (animalList.length > 0) {
          ...
          // Set first animal for production stats
  ...
  // Fetch production stats when selectedAnimalId changes
  useEffect(() => {
    ...
    if (isAuthenticated && selectedAnimalId) {
      fetchStats();
    }
  }, [isAuthenticated, selectedAnimalId]);
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-card shadow-sm p-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Button variant="ghost" size="sm" className="md:hidden" onClick={() => toast.info('Mobile menu TBD')}>
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-3xl font-bold">{animalStats.totalAnimals}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent>
                        <p className="text-3xl font-bold">{animalStats.mostCommonType}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent>
                        <p className="text-3xl font-bold">{animalStats.averageAge.toFixed(1)} yrs</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent>
                        <p className="text-3xl font-bold">{animalStats.breedingStockCount}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader>
