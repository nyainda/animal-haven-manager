...
import { Dog, Cat, Bird, Plus, FileText, Home, User, LogOut } from 'lucide-react';
      ...
      <aside className="w-64 bg-white dark:bg-gray-800 shadow-md">
        ...
        <nav className="mt-6">
          ...
          <div className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
            <div className="flex items-center">
              <Dog className="h-5 w-5 text-gray-500 dark:text-gray-400" />
          ...
          <div className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer" onClick={handleLogout}>
            <div className="flex items-center">
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <Card className="p-6 hover:shadow-md transition-all duration-200">
              <h3 className="font-medium text-gray-500 dark:text-gray-400">Total Animals</h3>
              <p className="text-3xl font-bold mt-2">17</p>
              <p className="text-green-500 mt-2 text-sm">+2 this month</p>
            </Card>
            <Card className="p-6 hover:shadow-md transition-all duration-200">
              <h3 className="font-medium text-gray-500 dark:text-gray-400">Species</h3>
            ...
            <Card className="p-6 hover:shadow-md transition-all duration-200">
              <h3 className="font-medium text-gray-500 dark:text-gray-400">Health Alerts</h3>
