...
const AnimalActivities: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-4xl">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Activities for {animal.name}</h1>
        <Button onClick={() => navigate(`/animals/${id}/activities/new`)}>
        ...
        <CardContent>
          <div className="rounded-lg border border-dashed p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              No activities have been recorded for this animal yet.
            </p>
            <Button onClick={() => navigate(`/animals/${id}/activities/new`)}>
              Add Activity
            </Button>
...
export default AnimalActivities;
